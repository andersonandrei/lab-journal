...
#+TAGS: Book(b) Code(C) Paper(P) Presentation(p) Scheduler(S) Denis(d) Clément(c) Andrei(a) Qarnot(q)
...
| *Name*      |    *Tasks* | *Resources* | *Status* |   |   |
|             |            |             |          |   |   |
| simple      |          8 |          10 | PASS     |   |   |
| simple_more |          8 |           4 | PASS     |   |   |
| 1day        |        418 |        1000 | PASS     |   |   |
| 1day_more   |        418 |         724 | PASS     |   |   |
| 1week       |          x |           x | PASS     |   |   |
| 1week_more  |          x |           x | PASS     |   |   |
|             |            |             |          |   |   |
