...
**** Maybe will be produced a real simple scenario, to be compared.
...
**** TODO To fix the diagram. The steps 3-5 are not too accurate. The Node does not ask the update of the resources. It is done time by time. :Paper:
**** Digitalisation, energy and data demand: The impact of Internet trafficonoverall and peak electricity consumption
