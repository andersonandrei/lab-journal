...
- State "WAITING"    from "TODO"       [2019-03-07 qui 17:34] \\
  Almost done. 
  * We added one more line in the QBoxSched, need to commit it.
:END:      
...
** it is rejected.
** TODO To check with Clément this rejections. I think the jobs should be reeschedule, but we do not have it yet, I think.
