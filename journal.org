...
*** TODO To fix the diagram slides
*** TODO To check the diff for the real one.
*** TODO To add an arrow to show were we are doing the modifications in the new sched
** monday, 15-04-2019
** Danilo's call
*** TODO To say that the measurement of the temperatures was achivied soon.
*** TODO To run different kinds of workloads
*** TODO How to validate the the simulator looking to the temperatures,considering external factors.
*** TODO TO show the graphs of the diff, unexpected results
*** TODO How to explain more preempted
*** TODO Staging jobs is how we are simulating. When we want to process and requires an data set, we create a staging_job to simulate the data tranfer.
*** TODO What is the difference between the preempted and the rejected jobs?
*** TODO QNode to QBox
