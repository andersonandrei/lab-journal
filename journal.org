...
*** TODO To check the jupyter notebook with Pierre.
*** TODO To do the simulation runs on Jupyter Notebook.
** 
** REPORT Resubmission was done.                                :WeekReview:
** REPORT To do the resubmission I created a new method on batsim.py. :WeekReview:
** REPORT Jupyter Notebook for whole analyzes (job allocation and temperature). :WeekReview:
** REPORT I though to analyze the energy consumption.           :WeekReview:
