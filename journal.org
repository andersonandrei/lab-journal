...
:END:      
*** TODO Write the explaination of the translation from the real to the simulated platform 
*** TODO Write the description of the simulated platform
...
:END:      
**** TODO if the computation of the list of the qbox for each consdition would make difference (for the LocalityBased).
**** TODO Should I explain details of the StorageController based on the deliverable?
*** TODO To change and run the Locality Based to re-compute the list of available_mobos for each priority.
