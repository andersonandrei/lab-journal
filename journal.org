...
* Week 02-05 / 08-05
** thursday, 02-05-2019
*** TODO To compare the means properly, for the Static Scheduler. The qarnot_extracted_temperatures.csv has the mean measured for each hour. Our output has the timestamp for each 600s.
