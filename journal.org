...
** thursday, 09-05-2019
*** TODO To update the location based scheduler regarding the last modifications in the standard one.
*** TODO Extract more workloads
*** TODO Run the simulation
*** TODO Plot the log-analyzes (pre-analyzes) and the gantt-chart.
*** TODO Ask Alex about the data-transfer validation
*** TODO Analyze also the outputs of pybatsim: nb_preempted_jobs, staginf_jobs and etc.
