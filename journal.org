...
** tuesday, 09-04-2019
*** TODO To check the data movements, aka., the job allocation of my scheduler.
**** Looking as working :D. See example: triplet1 and 2 at subtime:300
*** TODO To change the print of names in the GanttChart with Evalys
...
| Workflow diagram  | WAITING REVIEW | REVIEW           |
|                   |                |                  |
