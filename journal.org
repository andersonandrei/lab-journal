...
** TODO Work on
*** TODO the priority of QBoxes that have available QRads without preemption
...
:END:      
**** (skip it now)
*** TODO the count of available QRads for the priority of j in descending order
...
:END:      
*** TODO Organize the code. Use the doDispatch() as the main peace of the method schedule(). At the moment, it is duplicated.
