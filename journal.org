...
*** TODO Put the bibTex of all references, clean a little bit more and discuss it with Denis.
*** I plot the results of the last simulation.
*** TODO Analyze the plots.
*** TODO I figured out that the script to the metrics takes in account the staging_jobs.csv to compute the data transfet and nb_staging_jobs.
